                ...
                <div class="container">
                    <div class="content-center brand">
                      <!--  <img src="../assets/img/elogo.png" alt="Circle Image" class="rounded-circle">-->
                        <br><br>
                        <h3>Flying off the bookshelves.</h3>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <ul class="thumbnails">
                            ...
                            <div class="row-sm-3">
                                ...
                                <div class="caption">
                                  ...
                                  <h6><a class="btn btn-success btn-round" title="Click for more details!" href="admin_product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">INR<?php echo $res['prod_price']; ?></medium></h6>
                                </div>
