        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row content">
                    <div class="col-lg-6">
                        <p>
                            Shreeshamjee Plastic Industries” is a well-known entity established in 2010 at Narela, Delhi (India).
                        </p>
                        <ul>
                            <li><i class="ri-check-double-line"></i> We work towards the accomplishment of our goals, vision, and commitment.</li>
                            <li><i class="ri-check-double-line"></i> We provide quality products at the least possible rates.</li>
                            <li><i class="ri-check-double-line"></i> Timely delivery of consignments</li>
                            <li><i class="ri-check-double-line"></i> We follow fair, transparent, and ethical business policies</li>
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0">
                        <p>
                            Our company is counted amongst the foremost Trader, Wholesalers, and Exporters of Polypropylene Products such as Polypropylene (PP), Low-Density Polypropylene (LDPE), Cellulose Propionate (CP), General Purpose Polystyrene (GPPS), High-Density Polypropylene (HDPE) & CRYSTAL in all-natural with color.
                        </p>
