...
?>   
    <div class="row-sm-3">
        ...
        <div class="caption">
          ...
          <h6><a class="btn btn-success btn-round" title="Click for more details!" href="pages/product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">INR<?php echo $res['prod_price']; ?></medium></h6>
        </div>
