...
{
  header('Location: ./rhome.php');// if session exist for receiver then redirection to homepage of receceiver
}?>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li  class="active"><a href="./receiver_login.php">Login</a></li>
...
<br><br><br><br><br><br><br>
      <div class="container" data-aos="fade-up">
        <div class="panel panel-success panel-size-custom">
          ...
          <div class="col-lg-6">
            <form action="./receiver_login_reg.php" method="POST">
              <div class="form-row">
