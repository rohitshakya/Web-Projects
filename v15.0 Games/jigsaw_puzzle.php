   ...
   <script>
       ...
       */
       ...
       // end Segment
       //-------------------------------------------------------------------------
       let uploadFile; { // scope for uploadFile
       ...
       */
           ...
           if (!this.menu) {
               this.menu = new Menu({
                   ...
                   lines: [{
                       ...
                       {
                           text: "4 piece",
                           func: this.returnFunct(4)
                       },
                       {
                           text: "12 piece",
                           func: this.returnFunct(12)
                       },
                       {
                           text: "25 piece",
                           func: this.returnFunct(25)
                       },
                       {
                           text: "50 piece",
                           func: this.returnFunct(50)
                       },
                       {
                           text: "100 piece",
                           func: this.returnFunct(100)
                       },
                       {
                           text: "200 piece",
                           func: this.returnFunct(200)
                       }
                   ]
               });
           }
       ...
       Puzzle.prototype.mouseUpGame = function(event) {
           ...
           if (!yesyesMerge) {
               ...
               for (k = idp;
                   (k < this.polyPieces.length) && (this.polyPieces[k].pieces.length >= tmp.pieces.length); k++);
       ...
       Puzzle.prototype.lookForPiece = function(event) {
           ...
           for (kp = this.polyPieces.length - 1; kp >= 0; kp--) {
               for (kn = this.polyPieces[kp].pieces.length - 1; kn >= 0; kn--) {
                   if (this.polyPieces[kp].pieces[kn].insidePiece(x, y)) return {
                       pp: kp,
                       pc: kn
                   };
               } // for kn
       ...
       */
       ...
       Puzzle.prototype.computenxAndny = function() {
           ...
           let kx, ky, width = this.image.width,
