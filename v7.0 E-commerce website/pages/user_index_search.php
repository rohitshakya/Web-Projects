    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="user_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Rohit Shakya, Inc." data-placement="bottom" target="">
                    EcartBooks
                </a>
                        ...
                        <ul class="thumbnails">
                            ...
                            <div class="row-sm-3">
                                ...
                                <div class="caption">
                                  ...
                                  <h6><a class="btn btn-success btn-round" title="Click for more details!" href="user_product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">INR<?php echo $res['prod_price']; ?></medium></h6>
                                </div>
