...
{
  header('Location: ./hhome.php'); //if logged in by hospital, then redirect to hospital's homepage
}
?> 
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="./hospital_login.php">Admin</a></li>
...
<br><br><br><br><br><br><br>
      <div class="container" data-aos="fade-up">
        <div class="panel panel-success panel-size-custom">
          ...
          <div class="col-lg-6">
            <form action="./hospital_login_reg.php" method="POST">
              <div class="form-row">
